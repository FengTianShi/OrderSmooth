...
CREATE TABLE IF NOT EXISTS public.t_restaurant (
    ...
    restaurant_tel character varying(15) NOT NULL,
    restaurant_postal_code character varying(15) NOT NULL,
    restaurant_latitude double precision NOT NULL default 0,
    restaurant_longitude double precision NOT NULL default 0,
    restaurant_service_distance integer NOT NULL default 200,
    is_limit_service_distance boolean NOT NULL default false,
...
CREATE TABLE IF NOT EXISTS public.t_printer_i18n (
    ...
    printer_location character varying(500) NOT NULL,
