...
public class OwnerLoginService {
    ...
    public String ownerLogin(OwnerLoginParamDTO ownerLoginParamDTO) {
        ...
        Owner owner = ownerService.getOwnerByEmail(ownerLoginParamDTO.getOwnerEmail());
        ...
        OwnerLoginMgt ownerLoginMgt = ownerLoginMgtService
                .getOwnerLoginMgt(owner.getOwnerId(), ownerLoginParamDTO.getIpAddress());

        if (ownerLoginMgt == null) {
            ownerLoginMgt = OwnerLoginMgt.builder()
            ...
            ownerLoginMgtService.insertOwnerLoginMgt(ownerLoginMgt);
        }

        if (!StringUtils.encryptPassword(ownerLoginParamDTO.getOwnerPassword()).equals(owner.getOwnerPassword())) {
            ...
            if (ownerLoginMgt.getFailureCount() >= ownerLoginFailureMaxTimes) {
                ...
                ownerLoginMgt.setBanEndTime(nowTime.plusSeconds(ownerLoginFailureBanSeconds));
            }
